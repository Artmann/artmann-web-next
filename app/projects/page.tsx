...
function LibraryItem({ library }: { library: Library }): ReactElement {
  ...
  return (
    <div className="mb-12">
      <div className="flex items-center mb-4">
        <img
          alt="icon"
          className="block mr-4 w-8 h-8"
          src={library.icon}
        />
        <h3 className="block text-xl m-0">{library.name}</h3>
      </div>

      <p className="mb-4 max-w-lg">{library.description}</p>
...
const libraries: Library[] = [
  ...
  },
  {
    ...
    description:
      'Digital menu platform that lets restaurants create beautiful, mobile-friendly QR code menus they can update instantly from their phone.',
    icon: icons.react
  },
  {
    name: 'PMKIN',
    description:
      'PMKIN makes content creation effortless with an intuitive editor that lets your team focus on writing. Centralize all your content, seamlessly integrate with Next.js, and publish updates faster—without bottlenecks or code.',
  ...
  },
  {
    ...
    description:
      'Resources and tutorials for learning JavaScript, TypeScript and React.',
    icon: icons.react
  },
  {
